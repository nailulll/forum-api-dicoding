...
describe("ReplyRepositoryPostgres", () => {
    ...
    describe("verifyReplyOwner function", () => {
        it("should throw AuthorizationError when reply not owner", async () => {
            ...
            await expect(replyRepositoryPostgres.verifyReplyOwner('reply-123', fakeUserId)).rejects.toThrowError('anda tidak berhak mengakses resource ini');
        });
        ...
        it("should verify reply correctly", async () => {
            ...
            const reply = await replyRepositoryPostgres.verifyReplyOwner('reply-123', fakeUserId);
    ...
    describe("findReplyById function", () => {
        ...
        it("should throw NotFoundError when reply not found", async () => {
            await expect(replyRepositoryPostgres.findReplyById('reply-123')).rejects.toThrowError('balasan tidak ditemukan');
        });
    });
