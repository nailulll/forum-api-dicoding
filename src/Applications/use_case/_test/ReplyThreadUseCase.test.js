...
describe("ReplyThreadUseCase", () => {
    it("should orchestrating the add reply action correctly", async () => {
        ...
        const mockReply = new AddedReply({id: "reply-123", content: useCasePayload.content, owner: userId});
        ...
        mockReplyRepository.addReply = jest.fn().mockImplementation(() => Promise.resolve(mockReply));
